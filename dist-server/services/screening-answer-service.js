...
function findExactSavedAnswer(profile, prompt, length) {
...
function getTopProject(profile) {
...
function trimForShort(answer) {
    return answer.length <= 160 ? answer : `${answer.slice(0, 157).trimEnd()}...`;
}
function categoryAnswer(profile, category, length, context) {
...
export class ScreeningAnswerService {
    ...
    answerQuestion(prompt, length, context = {}) {
